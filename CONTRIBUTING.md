Contributing to AlpineBot Core
============================

The AlpineBot Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AlpineBot Core project, and is not to be
confused with overall AlpineBot Network Protocol consensus changes.

Whether a pull request is merged into AlpineBot Core rests with the project merge
...
Patches that change AlpineBot consensus rules are considerably more involved than
...
Where a patch set proposes to change the AlpineBot consensus, it must have been
...
The project leader is the release manager for each AlpineBot Core release.
