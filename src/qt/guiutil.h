...
/** Utility functions used by the AlpineBot Qt UI.
 */
namespace GUIUtil
{
...
// Render AlpineBot addresses in monospace font
...
// Parse "alpinebot:" URI into recipient object, return true on successful parsing
