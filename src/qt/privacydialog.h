...
public:
    ...
    void setZAlpineBotControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzALPB_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzALPB_clicked();
    void on_pushButtonZAlpineBotControl_clicked();
