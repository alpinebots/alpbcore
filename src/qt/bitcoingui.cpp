...
// Copyright (c) 2018 The Alpinebot developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Alpinebot-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Alpinebot address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and alpinebot: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Alpinebot Core"), this);
    aboutAction->setStatusTip(tr("Show information about Alpinebot Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Alpinebot"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Alpinebot addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Alpinebot addresses"));
    ...
    openAction->setStatusTip(tr("Open a Alpinebot: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Alpinebot Core help message to get a list with possible Alpinebot command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Alpinebot Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Alpinebot network", "", count));
}
...
{
    QString strTitle = tr("Alpinebot Core"); // default title
