...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AlpineBot Core"),
     ...
     * override -datadir in the alpinebot.conf file in the default data directory
     * (to be consistent with alpinebotd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
