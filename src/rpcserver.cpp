...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop AlpineBot server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "AlpineBot server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AlpineBot features */
        {"alpinebot", "masternode", &masternode, true, true, false},
        {"alpinebot", "listmasternodes", &listmasternodes, true, true, false},
        {"alpinebot", "getmasternodecount", &getmasternodecount, true, true, false},
        {"alpinebot", "masternodeconnect", &masternodeconnect, true, true, false},
        {"alpinebot", "masternodecurrent", &masternodecurrent, true, true, false},
        {"alpinebot", "masternodedebug", &masternodedebug, true, true, false},
        {"alpinebot", "startmasternode", &startmasternode, true, true, false},
        {"alpinebot", "createmasternodekey", &createmasternodekey, true, true, false},
        {"alpinebot", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"alpinebot", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"alpinebot", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"alpinebot", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"alpinebot", "getmasternodescores", &getmasternodescores, true, true, false},
        {"alpinebot", "mnbudget", &mnbudget, true, true, false},
        {"alpinebot", "preparebudget", &preparebudget, true, true, false},
        {"alpinebot", "submitbudget", &submitbudget, true, true, false},
        {"alpinebot", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"alpinebot", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"alpinebot", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"alpinebot", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"alpinebot", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"alpinebot", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"alpinebot", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"alpinebot", "checkbudgets", &checkbudgets, true, true, false},
        {"alpinebot", "mnsync", &mnsync, true, true, false},
        {"alpinebot", "spork", &spork, true, true, false},
        {"alpinebot", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"alpinebot", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use alpinebotd, or the -server option to alpinebot-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> alpinebot-cli " + methodname + " " + args + "\n";
}
