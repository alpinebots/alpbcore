...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AlpineBot Core alpinebot-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  alpinebot-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded alpinebot transaction") + "\n" +
                               "  alpinebot-tx [options] -create [commands]   " + _("Create hex-encoded alpinebot transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded alpinebot transaction
