...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/alpinebot-cli.cpp \
           src/alpinebot-tx.cpp \
           src/alpinebot.cpp \
           src/db.cpp \
           ...
           src/qt/alpinebot.cpp \
           src/qt/alpinebotstrings.cpp \
...
RESOURCES += src/qt/alpinebot.qrc src/qt/alpinebot_locale.qrc

TRANSLATIONS += src/qt/locale/alpinebot_bg.ts \
                src/qt/locale/alpinebot_de.ts \
                src/qt/locale/alpinebot_en.ts \
                src/qt/locale/alpinebot_es.ts \
                src/qt/locale/alpinebot_fi.ts \
                src/qt/locale/alpinebot_fr.ts \
                src/qt/locale/alpinebot_it.ts \
                src/qt/locale/alpinebot_ja.ts \
                src/qt/locale/alpinebot_pl.ts \
                src/qt/locale/alpinebot_pt.ts \
                src/qt/locale/alpinebot_ru.ts \
                src/qt/locale/alpinebot_sk.ts \
                src/qt/locale/alpinebot_sv.ts \
                src/qt/locale/alpinebot_vi.ts \
                src/qt/locale/alpinebot_zh_CN.ts \
                src/qt/locale/alpinebot_zh_TW.ts
